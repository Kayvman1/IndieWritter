...
<div id="form-container" class="container">
  <form id = "FORM">
    <div class="row">
      ...
      <div class="col-xs-8">
        <div class="form-group">
          ...
          <input class="form-control" name="display_name" type="text" value="Wall-E"></input>
        </div>
        <div class="form-group">
          <label for="location">Location</label>
          <input class="form-control"  name="location" type="text" value="Earth"></input>
        </div>
      </div>
    </div>
    <div class="row form-group">
      <label for="about">About me</label>
      <input name="about" type="hidden"></input>
    ...
    //     <textarea id = 'title' ref = {titleRef} placeholder='Title' className = 'form-control' name ='title' required={true}></textarea>
    //     <textarea id = 'content' ref = {contentRef} placeholder= 'Your Beautiful Work' className = 'form-control' name ='content' required ={true}></textarea>
